...
w = interact(ejemplo2,
             a = widgets.IntText(value=3,description=r"Valor de $a$"),
             r = widgets.FloatText(value=0.16,description=r"Valor de $r$"),
             k = widgets.IntText(value=20,description=r"Valor de $k$"))